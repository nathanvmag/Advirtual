  ...
  static Widget buildcontatoPage(Widget widget) => SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(padding: const EdgeInsets.only(left: 32), child: AppBottomSheetWidgets.phoneRow(Icons.print,"(24) 24841993")),
            Padding(padding: const EdgeInsets.only(left: 32), child: AppBottomSheetWidgets.phoneRow(Icons.print,"(21) 2498129392")),
  ...
  static Widget sectionItem(String header, String address) => Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            phoneRow(Icons.phone,"(24) 248422888"),
          ],
        ),
      );
